...
const VideoUploaderSingle = ({ title, setImages, isMultiple }) => {
  // ** State
  ...
  const { getRootProps, getInputProps } = useDropzone({
    ...
    onDrop: (acceptedFiles) => {
      ...
      body.append("file", ...acceptedFiles.map((file) => Object.assign(file)));

      axios
        .post(`${import.meta.env.VITE_BASE_API}/video`, body, {
          headers: {
